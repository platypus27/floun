...
- Tightened scan request validation so target URL credentials are stripped, tab IDs are non-negative, and URL, origin, protocol, and hostname must agree before background adapters run.
