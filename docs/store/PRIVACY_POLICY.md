...
Floun may process the active tab URL, hostname, page metadata, same-origin JavaScript text, TLS metadata, certificate metadata, and browser-visible token candidates that match local session-token heuristics.
