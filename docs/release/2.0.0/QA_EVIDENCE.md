...
- SHA-256: `3678d6ffca825377f55581a710fa7ec593209f25bf2428c27400c159ccfa1e50`
- Alias SHA-256: `3678d6ffca825377f55581a710fa7ec593209f25bf2428c27400c159ccfa1e50`
- Size bytes: `316997`
...
- `index.html`
- `background.js`
- `assets/ai-handler-aRBiC1Sy.js`
- `assets/index-lu6xBpGI.css`
- `assets/index-ZhPayV3S.js`
- `assets/pdfService-48S3Hgq-.js`
- `assets/scanProtocol-Bay6_EWv.js`
- `icons/favicon.ico`
- `icons/floun.png`
- `icons/icon_16.png`
- `icons/icon_48.png`
...
| deterministic packaging check | Pass | Two consecutive package runs produced matching SHA-256: `3678d6ffca825377f55581a710fa7ec593209f25bf2428c27400c159ccfa1e50`. |
...
| scan protocol runtime-guard tests | Pass | Negative tab IDs, malformed page headers, normalized TLS facts, certificate facts, adapter metadata, and warning arrays are rejected before adapters run or the popup accepts a success response. |
